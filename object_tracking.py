...
if __name__ == '__main__':
    ...
    # rate for running while loop per second, tested 7 is good for our robot      
    rate = rospy.Rate(7)
    ...
    # I use green hsv
    lower_b = (36, 25, 25) # (65, 43, 46) # green (36, 25, 25) 
    upper_b = (70, 255,255) # (110, 255, 255)# green (70, 255,255) 
